...
// WARNING: for speed, this is pretty much cut-and-paste from StringParser.scala
// If anything is broken there or here or in ChunkParser, you must fix all three (four!,
// as there are two ChunkParser implementations!) by hand!
