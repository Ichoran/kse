...
object Test_TupleImplicits extends Test_Kse {
  ...
  def test_tuple2 = {
    val t2 = ("fish", 4)
    t2._1Is("dog") == ("dog", 4) && t2._2Is(3) == ("fish", 3) &&
  ...
  def test_tuple3 = {
    val t3 = ("fish", 4, true)
    t3._1Is("dog") == t3.copy(_1 = "dog") && t3._2Is(3) == t3.copy(_2 = 3) && t3._3Is(false) == t3.copy(_3 = false) &&
  ...
  def test_tuple4 = {
    ...
    t4._1Is("dog") == t4.copy(_1 = "dog") && t4._2Is(3) == t4.copy(_2 = 3) && t4._3Is(false) == t4.copy(_3 = false) && t4._4Is(2.0) == t4.copy(_4 = 2.0) &&
  ...
  def test_tuple5 = {
    ...
    t5._1Is("dog") == t5.copy(_1 = "dog") && t5._2Is(3) == t5.copy(_2 = 3) && t5._3Is(false) == t5.copy(_3 = false) && t5._4Is(2.0) == t5.copy(_4 = 2.0) && t5._5Is(None) == t5.copy(_5 = Option.empty[String]) &&
